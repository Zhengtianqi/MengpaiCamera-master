...
import com.stickercamera.app.ui.EditCamera;
 ...
 * 相册界面
 */
public class AlbumActivity2 extends CameraBaseActivity {
    ...
    protected void onActivityResult(final int requestCode, final int resultCode, final Intent result) {
        if (requestCode == AppConstants.REQUEST_CROP && resultCode == RESULT_OK) {
            Intent newIntent = new Intent(AlbumActivity2.this, EditCamera.class);
